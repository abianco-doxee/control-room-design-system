...
Switch, Instrument, EmptyState, the severity **Shape**, the overlays (Modal on the
native `<dialog>`, Toast, Tooltip), the seeded pixel-**Cat** and the seeded
cyber-**Sigil** (both imperative
