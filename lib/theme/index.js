...
export const TYPE_OVERRIDABLE = [
  ...
  "--type-display-weight", "--type-display-tracking", "--type-display-leading", "--type-display-transform",
  "--type-label-tracking", "--type-label-transform",
];
...
export function defineTheme(name, brand, opts = {}) {
  ...
  const vars = opts.deriveOnColors === false ? merged : deriveOnColors(merged, { ...opts, changed });
