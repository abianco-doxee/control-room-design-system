...
- **Everything** — `@abianco-doxee/cr-design-system/components` (the full
...
- **Base + per-component** — import the thin chassis once, then one file per
  ...
  ```js
  import "@abianco-doxee/cr-design-system/base";          // resets, chassis, responsive, shared primitives
  import "@abianco-doxee/cr-design-system/styles/button.css";
  import "@abianco-doxee/cr-design-system/styles/calendar.css";
  ```
