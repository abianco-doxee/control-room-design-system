...
<link rel="stylesheet" href="@abianco-doxee/cr-design-system/structure.css" />
<link rel="stylesheet" href="@abianco-doxee/cr-design-system/themes/slate.css" />
```
...
`dist/theme-contract.json` (`@abianco-doxee/cr-design-system/theme-contract`) is the
...
`@abianco-doxee/cr-design-system/theme`; a test keeps the two (and tokens.json) in
...
### Programmatic authoring (`@abianco-doxee/cr-design-system/theme`)
...
import { defineTheme, applyTheme, validateTheme, checkThemeContrast }
  from "@abianco-doxee/cr-design-system/theme";
