...
@import "@abianco-doxee/cr-design-system/tailwind.css";   /* Tailwind + the CR @theme */
```

```html
<!-- load the runtime token layer once, and pick a theme -->
<link rel="stylesheet" href="@abianco-doxee/cr-design-system/css" />   <!-- dist/control-room.css -->
