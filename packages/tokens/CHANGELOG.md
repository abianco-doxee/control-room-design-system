# @abianco-doxee/cr-tokens

## 1.0.0

### Major Changes

- 78e5b68: First release — Control Room 1.0.0, published privately to GitHub Packages under the
  `@abianco-doxee` scope.
  ...
  [changelog](https://github.com/abianco-doxee/control-room-design-system/blob/main/CHANGELOG.md)
  for the full contents and
  [Getting Started](https://github.com/abianco-doxee/control-room-design-system/blob/main/references/getting-started.md)
  to wire it up.

### Patch Changes

- Updated dependencies [78e5b68]
  - @abianco-doxee/cr-utils@1.0.0
