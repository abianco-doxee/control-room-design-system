 ...
 * drips (cyber-sigilism). Imperative canvas repainted on mount and whenever
 * seed/state/size change; Mitosis resolves the ref per target.
 * See references/seeded-sigil.md. */
