 ...
 *  gets `target="_blank" rel="noopener noreferrer"`. See @abianco-doxee/cr-utils/href for the same
 *  detection outside a component.
 *  Styling: @abianco-doxee/cr-styles (components.css) (.cr-btn); `unstyled` drops the classes,
...
export default function CrButton(props: CrButtonProps) {
  const state = useStore({
    ...
    /* off-site link → new tab. Same logic as @abianco-doxee/cr-utils/href.isExternalHref, inlined
